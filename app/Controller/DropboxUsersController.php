...
class DropboxUsersController extends AppController {
    ...
    public function beforeFilter() {
        parent::beforeFilter();
        // $this->Auth->allow('register', 'logout', 'integrate_dropbox_account', 'login_via_dropbox');
        if (!$this->Auth->login()) {
...
//                    __('Invalid username or password, try again!'), 'flash_danger'
//            );
//        }
//    }
//
...
//    // }
//
//    public function integrate_dropbox_account($json) {
//        if(empty($json)) {
//            throw new NotFoundException(__("You have posted invalid data!"));
//        }
//        $data = json_decode($json);
//        pr($data);
//    }
//
//    public function login_via_dropbox($json = null) {
//        if($this->data);
//    }
//}
